...
<template>
    <div class="p-12">
        <h1 class="text-6xl flex justify-center color-primary">Sua cara metade:</h1>
        <div class="flex justify-around items-center gap-30">
            ...
            <div class="flex flex-col items-center gap-4">
                ...
                <button @click="acessApi" class="w-28 p-4 bg-primary text-white text-2xl font-semibold border-0 rounded-xl cursor-pointer hover:bg-primary/20 transition-all duration-300">Click! </button>
            </div>
